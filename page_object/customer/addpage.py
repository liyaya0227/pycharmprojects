...
customer_add_base_info = Element('customer/addbaseinfo')
customer_add_need_info = Element('customer/addneedinfo')
...
class CustomerAddPage(WebPage):
    ...
    def choose_phone_area(self, phone_area):
        self.is_click(customer_add_base_info['电话号_区域选择框'])
    ...
    def click_dialog_confirm_button(self):
        self.is_click(customer_add_base_info['弹窗_确定按钮'])
    ...
    def choose_purchase_house_purpose(self, purchase_house_purpose):
        self.is_click(customer_add_need_info['购房目的选择框'])
    ...
    def choose_rent_type(self, rent_type):
        self.is_click(customer_add_need_info['租赁方式选择框'])
    ...
    def input_min_room(self, min_room):
        self.is_click(customer_add_need_info['居室_最小选择框'])
    ...
    def input_max_room(self, max_room):
        self.is_click(customer_add_need_info['居室_最大选择框'])
        room_list = self.find_elements(customer_add_need_info['下拉框'])
        for room_ele in room_list:
    ...
    def choose_business_district(self, business_district):
        self.is_click(customer_add_need_info['商圈选择框'])
            ...
            for town in value:
                ...
                for town_ele in town_list:
                    if town_ele.text == town:
                        ...
                        sleep()
                        break
        self.is_click(customer_add_need_info['商圈确定按钮'])

    def choose_use(self, use):
        self.is_click(customer_add_need_info['用途选择框'])
    ...
    def choose_pay_type(self, pay_type):
        self.is_click(customer_add_need_info['付款方式选择框'])
    ...
    def choose_rent_range(self, rent_range):
        self.is_click(customer_add_need_info['租期选择框'])
