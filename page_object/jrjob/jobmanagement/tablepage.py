...
class JobManagementTablePage(WebPage):
    ...
    def input_handler_description_search(self, executor_handler):
        """输入任务描述搜索输入框"""
        self.input_text(table['任务描述搜索输入框'], executor_handler)
    ...
    def execute_once_job_by_row(self, row=1, param=None):
