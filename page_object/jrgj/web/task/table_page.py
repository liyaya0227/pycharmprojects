...
task_table = Element('jrgj/web/task/table')


class HouseTaskTablePage(WebPage):

    def switch_tab_by_tab_name(self, tab_name):
        locator = 'xpath', "//div[@style='' or not(@style)]/div[@class='new-house-management']//" \
    ...
    def get_record_no_by_house_name(self, house_name):
        locator = 'xpath', "//div[text()='" + house_name + "']/parent::td/preceding-sibling::td//a"
