...
create_sale_order_detail_wx = Element('jrgj/web/contract/createsaleorder_cz')
...
class ContractCreateSaleOrderDetailWXPage(WebPage):
    ...
    def input_buyer_info(self, buyer_info):
        ...
        self.click_element(create_sale_order_detail_wx['房屋出卖人_性别选择框'])
        ...
        self.click_element(create_sale_order_detail_wx['房屋出卖人_出生日期输入框'])
        self.input_text_with_enter(create_sale_order_detail_wx['房屋出卖人_出生日期输入框'], buyer_info['房屋出卖人_出生日期'])
        self.click_element(create_sale_order_detail_wx['房屋出卖人_证件名称选择框'])
    ...
    def input_seller_info(self, seller_info):
        ...
        self.click_element(create_sale_order_detail_wx['房屋买受人_性别选择框'])
        ...
        self.click_element(create_sale_order_detail_wx['房屋买受人_出生日期输入框'])
        self.input_text_with_enter(create_sale_order_detail_wx['房屋买受人_出生日期输入框'], seller_info['房屋买受人_出生日期'])
        self.click_element(create_sale_order_detail_wx['房屋买受人_证件名称选择框'])
    ...
    def input_sign_date_info(self, sign_date_info):
        self.click_element(create_sale_order_detail_wx['签署日期_输入框'])
    ...
    def input_first_info(self, first_info):
        ...
        if first_info['二'][0] == 1:
            self.click_element(create_sale_order_detail_wx['一_2_1_单选按钮'])
        elif first_info['二'][0] == 2:
            self.click_element(create_sale_order_detail_wx['一_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if first_info['二'][1] == 1:
            self.click_element(create_sale_order_detail_wx['一_2_3_单选按钮'])
        elif first_info['二'][1] == 2:
            self.click_element(create_sale_order_detail_wx['一_2_4_单选按钮'])
        else:
            raise ValueError('传值错误')
        if first_info['三'][0] == 1:
            self.click_element(create_sale_order_detail_wx['一_3_1_单选按钮'])
        elif first_info['三'][0] == 2:
            self.click_element(create_sale_order_detail_wx['一_3_2_单选按钮'])
        elif first_info['三'][0] == 3:
            self.click_element(create_sale_order_detail_wx['一_3_3_单选按钮'])
        elif first_info['三'][0] == 4:
            self.click_element(create_sale_order_detail_wx['一_3_4_单选按钮'])
        elif first_info['三'][0] == 5:
            self.click_element(create_sale_order_detail_wx['一_3_5_单选按钮'])
        elif first_info['三'][0] == 6:
            self.click_element(create_sale_order_detail_wx['一_3_6_单选按钮'])
        elif first_info['三'][0] == 7:
            self.click_element(create_sale_order_detail_wx['一_3_7_单选按钮'])
            self.input_text(create_sale_order_detail_wx['一_3_7_输入框'], first_info['三'][1])
        else:
            raise ValueError('传值错误')
        if first_info['四'][0] == 1:
            self.click_element(create_sale_order_detail_wx['一_4_1_单选按钮'])
        elif first_info['四'][0] == 2:
            self.click_element(create_sale_order_detail_wx['一_4_2_单选按钮'])
        elif first_info['四'][0] == 3:
            self.click_element(create_sale_order_detail_wx['一_4_3_单选按钮'])
        elif first_info['四'][0] == 4:
            self.click_element(create_sale_order_detail_wx['一_4_4_单选按钮'])
        elif first_info['四'][0] == 5:
            self.click_element(create_sale_order_detail_wx['一_4_5_单选按钮'])
    ...
    def input_second_info(self, second_info):
        if second_info['一_权属状况'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_1_1_1_单选按钮'])
        elif second_info['一_权属状况'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_1_1_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_wx['二_1_1_2_输入框'], second_info['一_权属状况'][1])
        if second_info['一_共有情况'] == 1:
            self.click_element(create_sale_order_detail_wx['二_1_2_1_单选按钮'])
        elif second_info['一_共有情况'] == 2:
            self.click_element(create_sale_order_detail_wx['二_1_2_2_单选按钮'])
        elif second_info['一_共有情况'] == 3:
            self.click_element(create_sale_order_detail_wx['二_1_2_3_单选按钮'])
        else:
            raise ValueError('传值错误')
        if second_info['一_持证方式'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_1_3_1_单选按钮'])
        elif second_info['一_持证方式'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_1_3_2_单选按钮'])
        ...
        if second_info['二_获得方式'] == 1:
            self.click_element(create_sale_order_detail_wx['二_2_2_1_单选按钮'])
        elif second_info['二_获得方式'] == 2:
            self.click_element(create_sale_order_detail_wx['二_2_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['二_2_3_输入框'])
        self.input_text_with_enter(create_sale_order_detail_wx['二_2_3_输入框'], second_info['二_土地使用年限'])
        if second_info['三'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_3_1_1_单选按钮'])
        elif second_info['三'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_3_1_1_单选按钮'])  # 待完善
        else:
            raise ValueError('传值错误')
        if second_info['四'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_4_1_1_单选按钮'])
        elif second_info['四'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_4_1_1_单选按钮'])  # 待完善
        else:
            raise ValueError('传值错误')
        if second_info['五'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_5_1_1_单选按钮'])
        elif second_info['五'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_5_1_1_单选按钮'])  # 待完善
        else:
            raise ValueError('传值错误')
        if second_info['六_房屋居住权情况'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_6_1_1_单选按钮'])
        elif second_info['六_房屋居住权情况'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_6_1_2_单选按钮'])
            self.input_text(create_sale_order_detail_wx['二_6_1_2_输入框'], second_info['六_房屋居住权情况'][1])
        else:
            raise ValueError('传值错误')
        if second_info['六_房屋居住处理方式'][0] == 1:
            self.click_element(create_sale_order_detail_wx['二_6_2_1_单选按钮'])
        elif second_info['六_房屋居住处理方式'][0] == 2:
            self.click_element(create_sale_order_detail_wx['二_6_2_2_单选按钮'])
        elif second_info['六_房屋居住处理方式'][0] == 3:
            self.click_element(create_sale_order_detail_wx['二_6_2_3_单选按钮'])
    ...
    def input_third_info(self, third_info):
        if third_info['二'] == 1:
            self.click_element(create_sale_order_detail_wx['三_2_1_单选按钮'])
        elif third_info['二'] == 2:
            self.click_element(create_sale_order_detail_wx['三_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if third_info['三_漏水'][0] == 1:
            self.click_element(create_sale_order_detail_wx['三_3_1_1_单选按钮'])
        elif third_info['三_漏水'][0] == 2:
            self.click_element(create_sale_order_detail_wx['三_3_1_2_单选按钮'])
            if 1 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_1_勾选框'])
            elif 2 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_2_勾选框'])
            elif 3 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_3_勾选框'])
            elif 4 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_4_勾选框'])
            elif 5 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_5_勾选框'])
            elif 6 in third_info['三_漏水'][1]:
                self.click_element(create_sale_order_detail_wx['三_3_2_6_勾选框'])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        if third_info['三_协商'][0] == 1:
            self.click_element(create_sale_order_detail_wx['三_3_3_1_单选按钮'])
        elif third_info['三_协商'][0] == 2:
            self.click_element(create_sale_order_detail_wx['三_3_3_2_单选按钮'])
            if third_info['三_协商'][1] == 1:
                self.click_element(create_sale_order_detail_wx['三_3_3_2_1_单选按钮'])
            elif third_info['三_协商'][2] == 2:
                self.click_element(create_sale_order_detail_wx['三_3_3_2_2_单选按钮'])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        if third_info['四_起泡'][0] == 1:
            self.click_element(create_sale_order_detail_wx['三_4_1_1_单选按钮'])
        elif third_info['四_起泡'][0] == 2:
            self.click_element(create_sale_order_detail_wx['三_4_1_2_单选按钮'])
            self.input_text(create_sale_order_detail_wx['三_4_1_2_输入框'], third_info['四_起泡'][1])
        else:
            raise ValueError('传值错误')
        if third_info['四_承担费用'] == 1:
            self.click_element(create_sale_order_detail_wx['三_4_2_1_单选按钮'])
        elif third_info['四_承担费用'] == 2:
            self.click_element(create_sale_order_detail_wx['三_4_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
    ...
    def input_five_info(self, five_info):
        ...
        if five_info['二'] == 1:
            self.click_element(create_sale_order_detail_wx['五_2_1_单选按钮'])
        elif five_info['二'] == 2:
            self.click_element(create_sale_order_detail_wx['五_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if len(five_info['二_1']) == 1:
            self.click_element(create_sale_order_detail_wx['五_2_1_1_1_输入框'])
            ...
            if five_info['二_1'][0][2] == 1:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_4_1_单选按钮'])
            elif five_info['二_1'][0][2] == 2:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_4_2_单选按钮'])
            elif five_info['二_1'][0][2] == 3:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_4_3_单选按钮'])
            else:
                raise ValueError('传值错误')
            ...
            if five_info['二_1'][1][2] == 1:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_8_1_单选按钮'])
            elif five_info['二_1'][1][2] == 2:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_8_2_单选按钮'])
            elif five_info['二_1'][1][2] == 3:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_8_3_单选按钮'])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        date_value = five_info['二_2_1'][0]
        self.click_element(create_sale_order_detail_wx['五_2_2_1_1_选择框'])
        ...
        if five_info['二_2_1'][2] == 1:
            self.click_element(create_sale_order_detail_wx['五_2_2_1_4_1_单选按钮'])
        elif five_info['二_2_1'][2] == 2:
            self.click_element(create_sale_order_detail_wx['五_2_2_1_4_2_单选按钮'])
        elif five_info['二_2_1'][2] == 3:
            self.click_element(create_sale_order_detail_wx['五_2_2_1_4_3_单选按钮'])
        elif five_info['二_2_1'][2] == 4:
            self.click_element(create_sale_order_detail_wx['五_2_2_1_4_4_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_wx['五_2_4_1_输入框'], five_info['二_2_4'][0])
        self.click_element(create_sale_order_detail_wx['五_2_4_3_选择框'])
        ...
        if five_info['二_2_4'][1][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['五_2_4_3_输入框'])
            self.input_text_with_enter(create_sale_order_detail_wx['五_2_4_3_输入框'], five_info['二_2_4'][1][1])
        else:
            raise ValueError('传值错误')
        if five_info['二_2_4'][2] == 1:
            self.click_element(create_sale_order_detail_wx['五_2_4_4_1_单选按钮'])
        elif five_info['二_2_4'][2] == 2:
            self.click_element(create_sale_order_detail_wx['五_2_4_4_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['五_2_5_1_选择框'])
        ...
        if five_info['二_2_5'][0][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['五_2_5_1_输入框'])
        ...
        self.click_element(create_sale_order_detail_wx['五_2_5_4_选择框'])
        ...
        if five_info['二_2_5'][2][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['五_2_5_4_输入框'])
            self.input_text_with_enter(create_sale_order_detail_wx['五_2_5_4_输入框'], five_info['二_2_5'][2][1])
        else:
            raise ValueError('传值错误')
        if five_info['二_2_5'][3] == 1:
            self.click_element(create_sale_order_detail_wx['五_2_5_5_1_单选按钮'])
        elif five_info['二_2_5'][3] == 2:
            self.click_element(create_sale_order_detail_wx['五_2_5_5_2_单选按钮'])
        else:
            raise ValueError('传值错误')

    def input_six_info(self, six_info):
        self.click_element(create_sale_order_detail_wx['六_1_选择框'])
        self.__choose_value_in_special_drop_down_box(six_info['网签手续日期'][0])
        if six_info['网签手续日期'][0] == 1:
            self.click_element(create_sale_order_detail_wx['六_1_输入框'])
            ...
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['六_2_选择框'])
        ...
        if six_info['转移登记日期'][0] in [1, 2, 4, 5]:
            ...
            self.click_element(create_sale_order_detail_wx['六_2_输入框'])
            self.input_text_with_enter(create_sale_order_detail_wx['六_2_输入框'], six_info['转移登记日期'][1])
        else:
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['六_3_选择框'])
    ...
    def input_seven_info(self, seven_info):
        self.click_element(create_sale_order_detail_wx['七_1_1_选择框'])
        self.__choose_value_in_special_drop_down_box(seven_info['一'][0])
        if seven_info['一'][0] == 1:
            self.click_element(create_sale_order_detail_wx['七_1_2_输入框'])
            ...
            raise ValueError('传值错误')
        if seven_info['三'] == 1:
            self.click_element(create_sale_order_detail_wx['七_3_2_1_单选按钮'])
        elif seven_info['三'] == 2:
            self.click_element(create_sale_order_detail_wx['七_3_2_2_单选按钮'])
        elif seven_info['三'] == 3:
            self.click_element(create_sale_order_detail_wx['七_3_2_3_单选按钮'])
        else:
            raise ValueError('传值错误')

    def input_eight_info(self, eight_info):
        if 1 in eight_info['一_1']:
            self.click_element(create_sale_order_detail_wx['八_1_1_1_勾选框'])
        if 2 in eight_info['一_1']:
            self.click_element(create_sale_order_detail_wx['八_1_1_2_勾选框'])
        if 3 in eight_info['一_1']:
            self.click_element(create_sale_order_detail_wx['八_1_1_3_勾选框'])
        if 4 in eight_info['一_1']:
            self.click_element(create_sale_order_detail_wx['八_1_1_4_勾选框'])
        if 5 in eight_info['一_1']:
            self.click_element(create_sale_order_detail_wx['八_1_1_5_勾选框'])
        if eight_info['一_2'] == 1:
            self.click_element(create_sale_order_detail_wx['八_1_2_1_单选按钮'])
        elif eight_info['一_2'] == 2:
            self.click_element(create_sale_order_detail_wx['八_1_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['一_3'] == 1:
            self.click_element(create_sale_order_detail_wx['八_1_3_1_单选按钮'])
        elif eight_info['一_3'] == 2:
            self.click_element(create_sale_order_detail_wx['八_1_3_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['一_4'] == 1:
            self.click_element(create_sale_order_detail_wx['八_1_4_1_单选按钮'])
        elif eight_info['一_4'] == 2:
            self.click_element(create_sale_order_detail_wx['八_1_4_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['二_税费'][0] == 1:
            self.click_element(create_sale_order_detail_wx['八_2_1_1_单选按钮'])
        elif eight_info['二_税费'][0] == 2:
            self.click_element(create_sale_order_detail_wx['八_2_1_2_单选按钮'])
        elif eight_info['二_税费'][0] == 3:
            self.click_element(create_sale_order_detail_wx['八_2_1_3_单选按钮'])
        elif eight_info['二_税费'][0] == 4:
            self.click_element(create_sale_order_detail_wx['八_2_1_4_单选按钮'])
            self.input_text(create_sale_order_detail_wx['八_2_1_4_输入框'], eight_info['二_税费'][1])
        else:
            raise ValueError('传值错误')
        if eight_info['二_新税费'] == 1:
            self.click_element(create_sale_order_detail_wx['八_2_2_1_单选按钮'])
        elif eight_info['二_新税费'] == 2:
            self.click_element(create_sale_order_detail_wx['八_2_2_2_单选按钮'])
        elif eight_info['二_新税费'] == 3:
            self.click_element(create_sale_order_detail_wx['八_2_2_3_单选按钮'])
        else:
            raise ValueError('传值错误')
    ...
    def input_commission_confirmation_info(self, commission_confirmation_info):
        ...
        if commission_confirmation_info['交易类型'] == 1:
            self.click_element(create_sale_order_detail_wx['佣金确认书_交易类型_出售_单选按钮'])
        elif commission_confirmation_info['交易类型'] == 2:
            self.click_element(create_sale_order_detail_wx['佣金确认书_交易类型_购买_单选按钮'])
        elif commission_confirmation_info['交易类型'] == 3:
            self.click_element(create_sale_order_detail_wx['佣金确认书_交易类型_转让_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_wx['佣金确认书_佣金金额_输入框'], commission_confirmation_info['佣金金额'])
        self.click_element(create_sale_order_detail_wx['佣金确认书_支付日期_选择框'])
    ...
    def input_commission_confirmation2_info(self, commission_confirmation2_info):
        ...
        if commission_confirmation2_info['交易类型'] == 1:
            self.click_element(create_sale_order_detail_wx['佣金确认书二_交易类型_出售_单选按钮'])
        elif commission_confirmation2_info['交易类型'] == 2:
            self.click_element(create_sale_order_detail_wx['佣金确认书二_交易类型_购买_单选按钮'])
        elif commission_confirmation2_info['交易类型'] == 3:
            self.click_element(create_sale_order_detail_wx['佣金确认书二_交易类型_转让_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_wx['佣金确认书二_佣金金额_输入框'], commission_confirmation2_info['佣金金额'])
        self.click_element(create_sale_order_detail_wx['佣金确认书二_支付日期_选择框'])
    ...
    def input_receipt_info(self, receipt_info):
        self.click_element(create_sale_order_detail_wx['收据_日期_输入框'])
        ...
        if 0 < len(collection_details) < 4:
            for collection in collection_details:
                self.click_element(create_sale_order_detail_wx['收据_支付日期' + str(collection_details.index(collection) + 1)
                                                               + '_输入框'])
