...
create_rent_order = Element('jrgj/web/contract/createrentorder')
...
class ContractCreateRentOrderPage(WebPage):
    ...
    def choose_house_administrative_region(self, region_info):
        self.click_element(create_rent_order['房屋所属行政区选择框'])
    ...
    def input_buyer_info(self, buyer_info):
        ...
        self.click_element(create_rent_order['房屋出租方_性别选择框'])
        ...
        self.click_element(create_rent_order['房屋出租方_出生日期输入框'])
        self.input_text_with_enter(create_rent_order['房屋出租方_出生日期输入框'], buyer_info['房屋出租方_出生日期'])
        self.click_element(create_rent_order['房屋出租方_证件名称选择框'])
    ...
    def input_seller_info(self, seller_info):
        ...
        self.click_element(create_rent_order['房屋承租方_性别选择框'])
        ...
        self.click_element(create_rent_order['房屋承租方_出生日期输入框'])
        self.input_text_with_enter(create_rent_order['房屋承租方_出生日期输入框'], seller_info['房屋承租方_出生日期'])
        self.click_element(create_rent_order['房屋承租方_证件名称选择框'])
    ...
    def input_first_info(self, first_info):
        self.click_element(create_rent_order['一_1_1_选择框'])
        ...
        if first_info['抵押情况'] == 1:
            self.click_element(create_rent_order['一_2_4_1_单选按钮'])
        elif first_info['抵押情况'] == 2:
            self.click_element(create_rent_order['一_2_4_2_单选按钮'])
        else:
    ...
    def input_third_info(self, third_info):
        self.click_element(create_rent_order['三_1_1_输入框'])
        self.input_text_with_enter(create_rent_order['三_1_1_输入框'], third_info['开始日期'])
        self.click_element(create_rent_order['三_1_2_输入框'])
    ...
    def input_four_info(self, four_info):
        ...
        if four_info['租金_支付方式'] == 1:
            self.click_element(create_rent_order['四_1_2_1_单选按钮'])
        elif four_info['租金_支付方式'] == 2:
            self.click_element(create_rent_order['四_1_2_2_单选按钮'])
        elif four_info['租金_支付方式'] == 3:
            self.click_element(create_rent_order['四_1_2_3_单选按钮'])
        else:
            raise ValueError("选项填值错误")
    ...
    def input_five_info(self, five_info):
        if 1 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_1_勾选框'])
        if 2 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_2_勾选框'])
        if 3 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_3_勾选框'])
        if 4 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_4_勾选框'])
        if 5 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_5_勾选框'])
        if 6 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_6_勾选框'])
        if 7 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_7_勾选框'])
        if 8 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_8_勾选框'])
        if 9 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_9_勾选框'])
        if 10 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_10_勾选框'])
        if 11 in five_info['出租方承担费用']:
            self.click_element(create_rent_order['五_1_11_勾选框'])
        if five_info['出租方承担其他费用'] != "":
            self.click_element(create_rent_order['五_1_12_勾选框'])
            self.input_text(create_rent_order['五_1_12_输入框'], five_info['出租方承担其他费用'])
        if 1 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_1_勾选框'])
        if 2 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_2_勾选框'])
        if 3 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_3_勾选框'])
        if 4 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_4_勾选框'])
        if 5 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_5_勾选框'])
        if 6 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_6_勾选框'])
        if 7 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_7_勾选框'])
        if 8 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_8_勾选框'])
        if 9 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_9_勾选框'])
        if 10 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_10_勾选框'])
        if 11 in five_info['承租方承担费用']:
            self.click_element(create_rent_order['五_2_11_勾选框'])
        if five_info['承租方承担其他费用'] != "":
            self.click_element(create_rent_order['五_2_12_勾选框'])
    ...
    def input_six_info(self, six_info):
        ...
        if six_info['出租方_支付方式'] == 1:
            self.click_element(create_rent_order['六_2_1_2_1_单选按钮'])
        elif six_info['出租方_支付方式'] == 2:
            self.click_element(create_rent_order['六_2_1_2_2_单选按钮'])
        elif six_info['出租方_支付方式'] == 3:
            self.click_element(create_rent_order['六_2_1_2_3_单选按钮'])
        else:
            raise ValueError("选项填值错误")
        self.input_text(create_rent_order['六_2_2_1_1_输入框'], six_info['承租方_金额'])
        if six_info['承租方_支付方式'] == 1:
            self.click_element(create_rent_order['六_2_2_2_1_单选按钮'])
        elif six_info['承租方_支付方式'] == 2:
            self.click_element(create_rent_order['六_2_2_2_2_单选按钮'])
        elif six_info['承租方_支付方式'] == 3:
            self.click_element(create_rent_order['六_2_2_2_3_单选按钮'])
        else:
            raise ValueError("选项填值错误")
