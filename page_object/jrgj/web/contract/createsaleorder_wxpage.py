...
create_sale_order_detail_wx = Element('jrgj/web/contract/createsaleorder_wx')
...
class ContractCreateSaleOrderDetailWXPage(WebPage):
    ...
    def choose_house_administrative_region(self, region_info):
        self.click_element(create_sale_order_detail_wx['房屋所属行政区选择框'])
    ...
    def input_common_seller_info(self, common_sellers_info):
        for common_seller_info in common_sellers_info:
            self.click_element(create_sale_order_detail_wx['房屋买受人_添加共同买受人按钮'])
            ...
            self.click_element(create_sale_order_detail_wx['房屋买受人_共同买受人'
                                                           + str(common_sellers_info.index(common_seller_info) + 1)
                                                           + '_性别选择框'])
    ...
    def input_first_info(self, first_info):
        ...
        if first_info['二'][1] == 1:
            ...
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['一_3_1_选择框'])
        ...
        if first_info['三'][0] > 7:
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['一_4_1_选择框'])
    ...
    def input_second_info(self, second_info):
        ...
        self.click_element(create_sale_order_detail_wx['二_2_2_选择框'])
        ...
        if second_info['三'][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['二_3_1_2_单选按钮'])
            ...
            self.click_element(create_sale_order_detail_wx['二_3_4_1_选择框'])
            if second_info['三'][1][0] == 1:
                self.__choose_value_in_special_drop_down_box(1)
            else:
                raise ValueError('传值错误')
            self.click_element(create_sale_order_detail_wx['二_3_4_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_wx['二_3_4_1_输入框'], second_info['三'][1][1])
            if second_info['三'][2][0] == 1:
                self.click_element(create_sale_order_detail_wx['二_3_5_1_单选按钮'])
            elif second_info['三'][2][0] == 2:
                self.click_element(create_sale_order_detail_wx['二_3_5_2_单选按钮'])
        ...
        if second_info['四'][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['二_4_1_2_单选按钮'])
            self.click_element(create_sale_order_detail_wx['二_4_2_1_输入框'])
            ...
            if second_info['四'][4][0] == 1:
                self.click_element(create_sale_order_detail_wx['二_4_3_1_单选按钮'])
                self.input_text(create_sale_order_detail_wx['二_4_3_1_输入框'], second_info['四'][4][1])
            elif second_info['四'][4][0] == 2:
                self.click_element(create_sale_order_detail_wx['二_4_3_2_单选按钮'])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        if second_info['五'][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['二_5_1_2_单选按钮'])
            self.click_element(create_sale_order_detail_wx['二_5_2_1_选择框'])
        ...
        if second_info['六_房屋居住权情况'][0] == 1:
            ...
            self.click_element(create_sale_order_detail_wx['二_6_2_1_选择框'])
    ...
    def input_five_info(self, five_info):
        ...
        for i in range(len(deposit_list)):
            ...
            self.click_element(date1_locator)
            ...
            if len(deposit_list) - deposit_list.index(deposit) != 1:
                self.click_element(create_sale_order_detail_wx['五_2_1_1_定金按钮'])
        ...
        for i in range(len(first_pay_list)):
            ...
            self.click_element(create_sale_order_detail_wx['五_2_2_' + flag + '_1_选择框'])
            ...
            if first_pay[0][0] == 1 or first_pay[0][0] == 4:
                ...
                self.click_element(create_sale_order_detail_wx['五_2_2_' + flag + '_1_输入框'])
            ...
            self.click_element(create_sale_order_detail_wx['五_2_2_' + flag + '_4_选择框'])
        ...
        if not five_info['二_3']:
            ...
            if five_info['二_3'][0] == 1:
                ...
                self.click_element(create_sale_order_detail_wx['五_2_3_1_1_2_单选按钮'])
            elif five_info['二_3'][0] == 3:
                self.click_element(create_sale_order_detail_wx['五_2_3_1_1_3_单选按钮'])
            else:
                raise ValueError('传值错误')
            ...
            if five_info['二_3'][3] == 1:
                ...
                self.click_element(create_sale_order_detail_wx['五_2_3_1_5_2_单选按钮'])
            else:
                raise ValueError('传值错误')
            if five_info['二_3'][4][0] == 1:
                self.click_element(create_sale_order_detail_wx['五_2_3_2_1_单选按钮'])
                self.click_element(create_sale_order_detail_wx['五_2_3_2_1_选择框'])
                if five_info['二_3'][4][1][0] == 1:
                    self.__choose_value_in_special_drop_down_box(1)
                    self.click_element(create_sale_order_detail_wx['五_2_3_2_1_输入框'])
                ...
                self.click_element(create_sale_order_detail_wx['五_2_3_2_2_单选按钮'])
                self.input_text(create_sale_order_detail_wx['五_2_3_2_2_输入框'], five_info['二_3'][4][1])
            elif five_info['二_3'][4][0] == 3:
                self.click_element(create_sale_order_detail_wx['五_2_3_2_3_单选按钮'])
            else:
                raise ValueError('传值错误')
        ...
        if five_info['二_4'][1][0] == 1:
            ...
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['五_2_4_4_选择框'])
        ...
        if five_info['二_5'][2][0] == 1:
            ...
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_wx['五_2_5_5_选择框'])
    ...
    def input_twelve_info(self, twelve_info):
        ...
        self.click_element(create_sale_order_detail_wx['十二_2_选择框'])
