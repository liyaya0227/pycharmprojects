...
create_sale_order_detail_sz = Element('jrgj/web/contract/createsaleorder_sz')
...
class ContractCreateSaleOrderDetailSZPage(WebPage):
    ...
    def choose_house_administrative_region(self, region_info):
        self.click_element(create_sale_order_detail_sz['房屋所属行政区选择框'])
    ...
    def input_buyer_info(self, buyer_info):
        ...
        self.click_element(create_sale_order_detail_sz['房屋出卖人_性别选择框'])
        ...
        self.click_element(create_sale_order_detail_sz['房屋出卖人_出生日期输入框'])
        self.input_text_with_enter(create_sale_order_detail_sz['房屋出卖人_出生日期输入框'], buyer_info['房屋出卖人_出生日期'])
        self.click_element(create_sale_order_detail_sz['房屋出卖人_证件名称选择框'])
    ...
    def input_seller_info(self, seller_info):
        ...
        if '房屋买受人' in keys:
            ...
            self.click_element(create_sale_order_detail_sz['房屋买受人_性别选择框'])
            ...
            self.click_element(create_sale_order_detail_sz['房屋买受人_出生日期输入框'])
            self.input_text_with_enter(create_sale_order_detail_sz['房屋买受人_出生日期输入框'], main_seller_info['房屋买受人_出生日期'])
            self.click_element(create_sale_order_detail_sz['房屋买受人_证件名称选择框'])
    ...
    def input_common_seller_info(self, common_sellers_info):
        for common_seller_info in common_sellers_info:
            self.click_element(create_sale_order_detail_sz['房屋买受人_添加共同买受人按钮'])
            ...
            self.click_element(create_sale_order_detail_sz['房屋买受人_共同买受人'
                                                           + str(common_sellers_info.index(common_seller_info) + 1)
                                                           + '_性别选择框'])
    ...
    def input_first_info(self, first_info):
        self.click_element(create_sale_order_detail_sz['一_1_1_选择框'])
        ...
        self.click_element(create_sale_order_detail_sz['一_3_1_选择框'])
        ...
        self.click_element(create_sale_order_detail_sz['一_3_3_选择框'])
        if first_info['土地使用权终止日期'][0] == 1:
            self.__choose_value_in_special_drop_down_box(1)
            self.click_element(create_sale_order_detail_sz['一_3_3_输入框'])
        ...
        self.click_element(create_sale_order_detail_sz['一_5_1_选择框'])
        self.__choose_value_in_drop_down_box(first_info['房屋用途'])
        self.click_element(create_sale_order_detail_sz['一_6_1_选择框'])
        self.__choose_value_in_drop_down_box(first_info['建筑结构'])
        self.click_element(create_sale_order_detail_sz['一_7_1_输入框'])
    ...
    def input_second_info(self, second_info):
        if second_info['房屋权证状况'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_1_1_单选按钮'])
        elif second_info['房屋权证状况'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_1_2_单选按钮'])
            self.input_text(create_sale_order_detail_sz['二_1_2_输入框'], second_info['房屋权证状况'][1])
        else:
            raise ValueError('传值错误')
        if second_info['房屋抵押状况'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_2_1_单选按钮'])
        elif second_info['房屋抵押状况'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_2_2_单选按钮'])
            self.click_element(create_sale_order_detail_sz['二_2_2_选择框'])
            if second_info['房屋抵押状况'][1][0] == 1:
                self.__choose_value_in_special_drop_down_box(1)
            else:
                raise ValueError('传值错误')
            self.click_element(create_sale_order_detail_sz['二_2_2_输入框'])
            self.input_text_with_enter(create_sale_order_detail_sz['二_2_2_输入框'], second_info['房屋抵押状况'][1][1])
        else:
            raise ValueError('传值错误')
        if second_info['房屋租赁状况'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_3_1_单选按钮'])
        elif second_info['房屋租赁状况'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_3_2_单选按钮'])
            self.input_text(create_sale_order_detail_sz['二_3_2_输入框'], second_info['房屋租赁状况'][1])
        else:
            raise ValueError('传值错误')
        if second_info['房屋居住权情况'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_10_1_单选按钮'])
        elif second_info['房屋居住权情况'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_10_2_单选按钮'])
            self.input_text(create_sale_order_detail_sz['二_10_2_1_输入框'], second_info['房屋居住权情况'][1][0])
            self.click_element(create_sale_order_detail_sz['二_10_2_2_选择框'])
        ...
        if second_info['房屋物业管理状况'] == 1:
            self.click_element(create_sale_order_detail_sz['二_4_1_单选按钮'])
        elif second_info['房屋物业管理状况'] == 2:
            self.click_element(create_sale_order_detail_sz['二_4_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if second_info['房屋户籍状况'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_5_1_单选按钮'])
        elif second_info['房屋户籍状况'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_5_2_单选按钮'])
            self.click_element(create_sale_order_detail_sz['二_5_2_1_选择框'])
        ...
        if second_info['房屋维修资金状'][0] == 1:
            self.click_element(create_sale_order_detail_sz['二_6_1_单选按钮'])
            if second_info['房屋维修资金状'][1][0] == 1:
                self.click_element(create_sale_order_detail_sz['二_6_1_1_单选按钮'])
            elif second_info['房屋维修资金状'][1][0] == 2:
                self.click_element(create_sale_order_detail_sz['二_6_1_2_单选按钮'])
            else:
                raise ValueError('传值错误')
        elif second_info['房屋维修资金状'][0] == 2:
            self.click_element(create_sale_order_detail_sz['二_6_2_单选按钮'])
            if second_info['房屋维修资金状'][1][0] == 1:
                self.click_element(create_sale_order_detail_sz['二_6_2_1_单选按钮'])
            elif second_info['房屋维修资金状'][1][0] == 2:
                self.click_element(create_sale_order_detail_sz['二_6_2_2_单选按钮'])
                self.input_text(create_sale_order_detail_sz['二_6_2_2_输入框'], second_info['房屋维修资金状'][1][1])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        self.click_element(create_sale_order_detail_sz['二_8_1_输入框'])
        self.input_text_with_enter(create_sale_order_detail_sz['二_8_1_输入框'], second_info['费用已支付日期'])
        self.click_element(create_sale_order_detail_sz['二_8_2_输入框'])
    ...
    def input_four_info(self, four_info):
        self.click_element(create_sale_order_detail_sz['四_单选按钮'])
        if four_info['选项'][0] == 1:
            self.click_element(create_sale_order_detail_sz['四_1_单选按钮'])
            if four_info['选项'][1][0] == 1:
                self.click_element(create_sale_order_detail_sz['四_1_1_选择框'])
                self.__choose_value_in_special_drop_down_box(1)
            else:
                raise ValueError('传值错误')
            self.click_element(create_sale_order_detail_sz['四_1_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_sz['四_1_1_输入框'], four_info['选项'][1][1])
        elif four_info['选项'][0] == 2:
            self.click_element(create_sale_order_detail_sz['四_2_单选按钮'])
            self.click_element(create_sale_order_detail_sz['四_2_1_输入框'])
            ...
            if four_info['选项'][1][2] == 1:
                self.click_element(create_sale_order_detail_sz['四_2_4_选择框'])
                self.__choose_value_in_special_drop_down_box(four_info['选项'][1][2])
            else:
                raise ValueError('传值错误')
            self.click_element(create_sale_order_detail_sz['四_2_8_选择框'])
    ...
    def input_seven_info(self, seven_info):
        self.click_element(create_sale_order_detail_sz['七_1_选择框'])
        index = seven_info['交付日期'][0]
        self.__choose_value_in_special_drop_down_box(index)
        if index == 1:
            self.click_element(create_sale_order_detail_sz['七_1_输入框'])
    ...
    def input_nine_info(self, nine_info):
        if nine_info['选项'][0] == 1:
            self.click_element(create_sale_order_detail_sz['九_1_单选按钮'])
            self.input_text(create_sale_order_detail_sz['九_1_输入框'], nine_info['选项'][1])
            if nine_info['选项'][2] == 1:
                self.click_element(create_sale_order_detail_sz['九_2_1_单选按钮'])
            elif nine_info['选项'][2] == 2:
                self.click_element(create_sale_order_detail_sz['九_2_2_单选按钮'])
            else:
                raise ValueError("填值错误")
        elif nine_info['选项'][0] == 2:
            self.click_element(create_sale_order_detail_sz['九_2_单选按钮'])
    ...
    def input_ten_info(self, ten_info):
        if ten_info['选项'][0] == 1:
            self.click_element(create_sale_order_detail_sz['十_1_选择框'])
            self.__choose_value_in_special_drop_down_box(1)
    ...
    def input_eleven_info(self, eleven_info):
        if eleven_info['选项'][0] == 1:
            self.click_element(create_sale_order_detail_sz['十一_1_单选按钮'])
        elif eleven_info['选项'][0] == 2:
            self.click_element(create_sale_order_detail_sz['十一_2_单选按钮'])
    ...
    def input_twelve_info(self, twelve_info):
        if twelve_info['选项'][0][0] == 1:
            self.click_element(create_sale_order_detail_sz['十二_1_1_单选按钮'])
        elif twelve_info['选项'][0][0] == 2:
            self.click_element(create_sale_order_detail_sz['十二_1_2_单选按钮'])
        elif twelve_info['选项'][0][0] == 3:
            self.click_element(create_sale_order_detail_sz['十二_1_3_单选按钮'])
        elif twelve_info['选项'][0][0] == 4:
            self.click_element(create_sale_order_detail_sz['十二_1_4_单选按钮'])
            self.input_text(create_sale_order_detail_sz['十二_1_4_输入框'], twelve_info['选项'][0][1])
        else:
            raise ValueError("选项填值错误")
        if twelve_info['选项'][1] == 1:
            self.click_element(create_sale_order_detail_sz['十二_1_5_输入框'])
            self.__choose_value_in_special_drop_down_box(1)
        else:
            raise ValueError("选项填值错误")
    ...
    def input_sixteen_info(self, sixteen_info):
        if sixteen_info['选项'] == 1:
            self.click_element(create_sale_order_detail_sz['十六_1_单选按钮'])
        elif sixteen_info['选项'] == 2:
            self.click_element(create_sale_order_detail_sz['十六_2_单选按钮'])
        else:
            raise ValueError("选项填值错误")
    ...
    def input_attachment_two_info(self, attachment_two_info):
        if attachment_two_info['装修房或毛坯房'] == '装修房':
            self.click_element(create_sale_order_detail_sz['附件二_1_1_单选按钮'])
        elif attachment_two_info['装修房或毛坯房'] == '毛坯房':
            self.click_element(create_sale_order_detail_sz['附件二_1_2_单选按钮'])
        else:
            raise ValueError()
        if attachment_two_info['甲方或乙方'] == '甲方':
            self.click_element(create_sale_order_detail_sz['附件二_6_1_单选按钮'])
        elif attachment_two_info['甲方或乙方'] == '乙方':
            self.click_element(create_sale_order_detail_sz['附件二_6_2_单选按钮'])
        else:
            raise ValueError()
    ...
    def input_supplementary_agreement_info(self, supplementary_agreement_info):
        ...
        for pay in deposit_list:
            ...
            if date[0] == 1:
                self.click_element(input1_locator)
            ...
            if pay['支付方式'] == 1:
                ...
                self.click_element(button2_locator)
            else:
                raise ValueError("传值错误")
            if len(deposit_list) - deposit_list.index(pay) != 1:
                self.click_element(create_sale_order_detail_sz['补充协议_1_1_1_定金按钮'])
        ...
        for house_payment in house_payment_list:
            ...
            if len(house_payment_list) - house_payment_list.index(house_payment) != 1:
                self.click_element(create_sale_order_detail_sz['补充协议_1_1_1_房款按钮'])

        house_deposit = supplementary_agreement_info['交房保证金']
        self.click_element(create_sale_order_detail_sz['补充协议_1_5_1_选择框'])
        ...
        if house_deposit_date[0] == 1:
            self.click_element(create_sale_order_detail_sz['补充协议_1_5_1_输入框'])
        ...
        if house_deposit['支付方式'] == 1:
            self.click_element(create_sale_order_detail_sz['补充协议_1_5_4_单选按钮'])
            self.click_element(create_sale_order_detail_sz['补充协议_1_5_6_选择框'])
            ...
            self.click_element(create_sale_order_detail_sz['补充协议_1_5_5_单选按钮'])
        else:
            raise ValueError("传值错误")
        resident_deposit = supplementary_agreement_info['户口迁出保证金']
        self.click_element(create_sale_order_detail_sz['补充协议_1_6_1_选择框'])
        ...
        if resident_deposit_date[0] == 1:
            self.click_element(create_sale_order_detail_sz['补充协议_1_6_1_输入框'])
        ...
        if resident_deposit['支付方式'] == 1:
            self.click_element(create_sale_order_detail_sz['补充协议_1_6_4_单选按钮'])
            self.click_element(create_sale_order_detail_sz['补充协议_1_6_6_选择框'])
            self.__choose_value_in_special_drop_down_box()
            self.input_text(create_sale_order_detail_sz['补充协议_1_6_6_输入框'], resident_deposit['其他'])
        elif resident_deposit['支付方式'] == 2:
            self.click_element(create_sale_order_detail_sz['补充协议_1_6_5_单选按钮'])
        else:
            raise ValueError("传值错误")
        ...
        if rent_status['是否'] == '是':
            self.click_element(create_sale_order_detail_sz['补充协议_4_1_单选按钮'])
        elif rent_status['是否'] == '否':
            self.click_element(create_sale_order_detail_sz['补充协议_4_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        taxation = supplementary_agreement_info['税费']
        if taxation['选项'] == 1:
            self.click_element(create_sale_order_detail_sz['补充协议_5_1_1_单选按钮'])
        elif taxation['选项'] == 2:
            self.click_element(create_sale_order_detail_sz['补充协议_5_1_2_单选按钮'])
        elif taxation['选项'] == 3:
            self.click_element(create_sale_order_detail_sz['补充协议_5_1_3_单选按钮'])
        elif taxation['选项'] == 4:
            self.click_element(create_sale_order_detail_sz['补充协议_5_1_4_单选按钮'])
        elif taxation['选项'] == 5:
            self.click_element(create_sale_order_detail_sz['补充协议_5_1_5_单选按钮'])
        else:
            raise ValueError('传值错误')
        if taxation['是否'] == '是':
            self.click_element(create_sale_order_detail_sz['补充协议_5_2_1_单选按钮'])
        elif taxation['是否'] == '否':
            self.click_element(create_sale_order_detail_sz['补充协议_5_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
    ...
    def input_commission_confirmation_info(self, commission_confirmation_info):
        ...
        if commission_confirmation_info['车位'] == '否':
            self.click_element(create_sale_order_detail_sz['佣金确认书_车位_否_单选按钮'])
        elif commission_confirmation_info['车位'] == '是':
            self.click_element(create_sale_order_detail_sz['佣金确认书_车位_有_单选按钮'])
        else:
            raise ValueError("传值错误")
        self.input_text(create_sale_order_detail_sz['佣金确认书_佣金金额_输入框'], commission_confirmation_info['佣金金额'])
        self.click_element(create_sale_order_detail_sz['佣金确认书_支付日期_选择框'])
        self.__choose_value_in_special_drop_down_box(1)
    ...
    def input_commission_confirmation2_info(self, commission_confirmation_info):
        ...
        if commission_confirmation_info['车位'] == '否':
            self.click_element(create_sale_order_detail_sz['佣金确认书二_车位_否_单选按钮'])
        elif commission_confirmation_info['车位'] == '是':
            self.click_element(create_sale_order_detail_sz['佣金确认书二_车位_有_单选按钮'])
        else:
            raise ValueError("传值错误")
        self.input_text(create_sale_order_detail_sz['佣金确认书二_佣金金额_输入框'], commission_confirmation_info['佣金金额'])
        self.click_element(create_sale_order_detail_sz['佣金确认书二_支付日期_选择框'])
        self.__choose_value_in_special_drop_down_box(1)
    ...
    def input_receipt_info(self, receipt_info):
        ...
        if len(collection_details) < 4:
            for collection in collection_details:
                self.click_element(create_sale_order_detail_sz['收据_支付日期'
