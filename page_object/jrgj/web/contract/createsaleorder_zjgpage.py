...
create_sale_order_detail_zjg = Element('jrgj/web/contract/createsaleorder_zjg')
...
class ContractCreateSaleOrderDetailZJGPage(WebPage):
    ...
    def choose_house_administrative_region(self, region_info):
        self.click_element(create_sale_order_detail_zjg['房屋所属行政区选择框'])
    ...
    def input_first_info(self, first_info):
        ...
        self.click_element(create_sale_order_detail_zjg['一_3_1_选择框'])
        ...
        self.click_element(create_sale_order_detail_zjg['一_5_1_选择框'])
        self.__choose_value_in_drop_down_box(first_info['五'])
        self.click_element(create_sale_order_detail_zjg['一_6_1_选择框'])
    ...
    def input_second_info(self, second_info):
        self.click_element(create_sale_order_detail_zjg['二_2_选择框'])
        ...
        for n, value in enumerate(second_info['二_1']):
            ...
            self.click_element(pay_type_locator)
            if 0 < value[2][0] <= 3:
            ...
            if len(second_info['二_1']) - n != 1:
                self.click_element(create_sale_order_detail_zjg['二_2_1_定金按钮'])
        for n, value in enumerate(second_info['二_2']):
            ...
            if len(second_info['二_2']) - n != 1:
                self.click_element(create_sale_order_detail_zjg['二_2_2_房款按钮'])
        for n, value in enumerate(second_info['二_3']):
            ...
            if len(second_info['二_3']) - n != 1:
                self.click_element(create_sale_order_detail_zjg['二_2_3_添加按钮'])
        if second_info['二'] == '贷款':
            self.click_element(create_sale_order_detail_zjg['二_2_4_1_选择框'])
        ...
        if 0 < second_info['二_5'][1][0] <= 4:
            self.click_element(create_sale_order_detail_zjg['二_2_5_3_选择框'])
        ...
        if 0 < second_info['二_5'][2][0] <= 3:
            self.click_element(create_sale_order_detail_zjg['二_2_5_4_选择框'])
    ...
    def input_third_info(self, third_info):
        ...
        if 0 < third_info[1][0] <= 2:
            self.click_element(create_sale_order_detail_zjg['三_2_选择框'])
    ...
    def input_four_info(self, four_info):
        if 0 < four_info[0] <= 3:
            self.click_element(create_sale_order_detail_zjg['四_选择框'])
    ...
    def input_six_info(self, six_info):
        self.click_element(create_sale_order_detail_zjg['六_1_1_1_选择框'])
        self.__choose_value_in_drop_down_box(six_info['一_1'])
        if six_info['一_2'] == 1:
            self.click_element(create_sale_order_detail_zjg['六_1_2_1_单选按钮'])
        elif six_info['一_2'] == 2:
            self.click_element(create_sale_order_detail_zjg['六_1_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_zjg['六_2_1_输入框'], six_info['二'])
        if six_info['三'][0] == 1:
            self.click_element(create_sale_order_detail_zjg['六_3_1_单选按钮'])
        elif six_info['三'][0] == 2:
            self.click_element(create_sale_order_detail_zjg['六_3_2_单选按钮'])
        elif six_info['三'][0] == 3:
            self.click_element(create_sale_order_detail_zjg['六_3_3_单选按钮'])
        elif six_info['三'][0] == 4:
            self.click_element(create_sale_order_detail_zjg['六_3_4_单选按钮'])
    ...
    def input_commission_confirmation_info(self, commission_confirmation_info):
        ...
        self.click_element(create_sale_order_detail_zjg['佣金确认书_支付日期_选择框'])
    ...
    def input_commission_confirmation2_info(self, commission_confirmation_info):
        ...
        self.click_element(create_sale_order_detail_zjg['佣金确认书二_支付日期_选择框'])
        self.__choose_index_in_drop_down_box(commission_confirmation_info['支付日期'][0])
        if commission_confirmation_info['支付日期'][0] == 2:
