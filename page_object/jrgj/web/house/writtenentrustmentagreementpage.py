...
written_entrustment_agreement = Element('jrgj/web/house/writtenentrustmentagreement')
...
class WrittenEntrustmentAgreementPage(WebPage):
    ...
    def input_entrustment_start_date(self, start_date):
        ...
        self.click_element(written_entrustment_agreement['委托日期开始日期输入框'])
    ...
    def input_entrustment_end_date(self, end_date):
        ...
        self.click_element(written_entrustment_agreement['委托日期结束日期输入框'])
    ...
    def click_submit_button(self):
        self.click_element(written_entrustment_agreement['提交按钮'], sleep_time=2)
