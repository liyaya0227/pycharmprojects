...
table = Element('jrgj/web/paymentflow/table')
...
class PaymentFlowTablePage(WebPage):
    ...
    def get_table_row_data(self, row=1):
        ...
        row_data['佣金'] = self.get_element_text(commission_locator).replace(',', '')
        ...
        row_data['收款人'] = self.get_element_text(payee_locator)
        ...
        row_data['支付时间'] = self.get_element_text(pay_time_locator)
        ...
        row_data['成交人'] = self.get_element_text(deal_person_locator)
        ...
        row_data['支付渠道'] = self.get_element_text(payment_channel_locator)
