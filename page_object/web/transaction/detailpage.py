...
transaction_detail = Element('web/transaction/detail')
...
class TransactionDetailPage(WebPage):
    ...
    def complete_transfer_house(self):
        ...
        self.is_click(transaction_detail['完成按钮'], sleep_time=1)
    ...
    def show_sensitive_info(self):
        ...
        if flag == '显示敏感信息':
            self.is_click(transaction_detail['显示隐藏敏感信息按钮'], sleep_time=0.5)
        else:
            pass
