...
create_sale_order_detail_hz = Element('web/contract/createsaleorder_hz')
...
class ContractCreateSaleOrderDetailWXPage(WebPage):
    ...
    def input_sign_date_info(self, sign_date_info):
        self.is_click(create_sale_order_detail_hz['签署日期_输入框'])
        self.input_text_with_enter(create_sale_order_detail_hz['签署日期_输入框'], sign_date_info)

    def input_first_info(self, first_info):
        self.input_text(create_sale_order_detail_hz['一_1_1_输入框'], first_info['详细地址'])
        self.input_text(create_sale_order_detail_hz['一_1_2_输入框'], first_info['建筑面积'])
        if first_info['二'][0] == 1:
            self.is_click(create_sale_order_detail_hz['一_2_1_单选按钮'])
        elif first_info['二'][0] == 2:
            self.is_click(create_sale_order_detail_hz['一_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if first_info['二'][1] == 1:
            self.is_click(create_sale_order_detail_hz['一_2_3_单选按钮'])
        elif first_info['二'][1] == 2:
            self.is_click(create_sale_order_detail_hz['一_2_4_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['一_3_1_选择框'])
        self.__choose_value_in_special_drop_down_box(first_info['三'][0])
        if first_info['三'][0] == 7:
            self.input_text(create_sale_order_detail_hz['一_3_1_输入框'], first_info['三'][1])
        if first_info['三'][0] > 7:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['一_4_1_选择框'])
        self.__choose_value_in_special_drop_down_box(first_info['四'][0])
        if first_info['四'][0] == 5:
            self.input_text(create_sale_order_detail_hz['一_4_1_输入框'], first_info['四'][1])
        if first_info['四'][0] > 5:
            raise ValueError('传值错误')

    def input_second_info(self, second_info):
        if second_info['一_权属状况'][0] == 1:
            self.is_click(create_sale_order_detail_hz['二_1_1_1_单选按钮'])
        elif second_info['一_权属状况'][0] == 2:
            self.is_click(create_sale_order_detail_hz['二_1_1_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_hz['二_1_1_2_输入框'], second_info['一_权属状况'][1])
        if second_info['一_共有情况'] == 1:
            self.is_click(create_sale_order_detail_hz['二_1_2_1_单选按钮'])
        elif second_info['一_共有情况'] == 2:
            self.is_click(create_sale_order_detail_hz['二_1_2_2_单选按钮'])
        elif second_info['一_共有情况'] == 3:
            self.is_click(create_sale_order_detail_hz['二_1_2_3_单选按钮'])
        else:
            raise ValueError('传值错误')
        if second_info['一_持证方式'][0] == 1:
            self.is_click(create_sale_order_detail_hz['二_1_3_1_单选按钮'])
        elif second_info['一_持证方式'][0] == 2:
            self.is_click(create_sale_order_detail_hz['二_1_3_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_hz['二_1_3_2_输入框'], second_info['一_持证方式'][1])
        self.input_text(create_sale_order_detail_hz['二_2_1_输入框'], second_info['二_土地使用权证证号'])
        self.is_click(create_sale_order_detail_hz['二_2_2_选择框'])
        self.__choose_value_in_drop_down_box(second_info['二_获得方式'])
        self.input_text_with_enter(create_sale_order_detail_hz['二_2_3_输入框'], second_info['二_土地使用年限'])
        if second_info['三'][0] == 1:
            self.is_click(create_sale_order_detail_hz['二_3_1_1_单选按钮'])
        elif second_info['三'][0] == 2:
            self.is_click(create_sale_order_detail_hz['二_3_1_2_单选按钮'])
            ...
            self.is_click(create_sale_order_detail_hz['二_3_4_1_选择框'])
            if second_info['三'][1][0] == 1:
                self.__choose_value_in_special_drop_down_box(1)
            else:
                raise ValueError('传值错误')
            self.is_click(create_sale_order_detail_hz['二_3_4_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['二_3_4_1_输入框'], second_info['三'][1][1])
            if second_info['三'][2][0] == 1:
                self.is_click(create_sale_order_detail_hz['二_3_5_1_单选按钮'])
            elif second_info['三'][2][0] == 2:
                self.is_click(create_sale_order_detail_hz['二_3_5_2_单选按钮'])
                self.input_text(create_sale_order_detail_hz['二_3_5_2_输入框'], second_info['三'][2][1])
        else:
            raise ValueError('传值错误')
        if second_info['四'][0] == 1:
            self.is_click(create_sale_order_detail_hz['二_4_1_1_单选按钮'])
        elif second_info['四'][0] == 2:
            self.is_click(create_sale_order_detail_hz['二_4_1_2_单选按钮'])
            self.is_click(create_sale_order_detail_hz['二_4_2_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['二_4_2_1_输入框'], second_info['四'][1])
            self.input_text(create_sale_order_detail_hz['二_4_2_2_输入框'], second_info['四'][2])
            self.input_text(create_sale_order_detail_hz['二_4_2_3_输入框'], second_info['四'][3])
            if second_info['四'][4][0] == 1:
                self.is_click(create_sale_order_detail_hz['二_4_3_1_单选按钮'])
                self.input_text(create_sale_order_detail_hz['二_4_3_1_输入框'], second_info['四'][4][1])
            elif second_info['四'][4][0] == 2:
                self.is_click(create_sale_order_detail_hz['二_4_3_2_单选按钮'])
            else:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
        if second_info['五'][0] == 1:
            self.is_click(create_sale_order_detail_hz['二_5_1_1_单选按钮'])
        elif second_info['五'][0] == 2:
            self.is_click(create_sale_order_detail_hz['二_5_1_2_单选按钮'])
        ...
        if second_info['六_房屋居住权情况'][0] == 1:
            ...
            self.input_text(create_sale_order_detail_hz['二_6_1_2_输入框'], second_info['六_房屋居住权情况'][1])
            self.is_click(create_sale_order_detail_hz['二_6_2_1_选择框'])
            self.__choose_value_in_special_drop_down_box(second_info['六_房屋居住处理方式'][0])
            if second_info['六_房屋居住处理方式'][0] == 3:
                self.input_text(create_sale_order_detail_hz['二_6_2_1_输入框'], second_info['六_房屋居住处理方式'][1])
            if second_info['六_房屋居住处理方式'][0] > 3:
                raise ValueError('传值错误')
        else:
            raise ValueError('传值错误')
    ...
    def input_third_info(self, third_info):
        if third_info['二'] == 1:
            self.is_click(create_sale_order_detail_hz['三_2_1_单选按钮'])
        elif third_info['二'] == 2:
            self.is_click(create_sale_order_detail_hz['三_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
    ...
    def input_five_info(self, five_info):
        self.input_text(create_sale_order_detail_hz['五_1_3_输入框'], five_info['一'])
        if five_info['二'] == 1:
            self.is_click(create_sale_order_detail_hz['五_2_1_单选按钮'])
        elif five_info['二'] == 2:
            self.is_click(create_sale_order_detail_hz['五_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        ...
        for i in range(len(deposit_list)):
            ...
            if len(deposit_list) - deposit_list.index(deposit) != 1:
                self.is_click(create_sale_order_detail_hz['五_2_1_1_定金按钮'])
        ...
        for i in range(len(first_pay_list)):
            ...
            self.is_click(create_sale_order_detail_hz['五_2_2_' + flag + '_1_选择框'])
            ...
            if first_pay[0][0] == 1 or first_pay[0][0] == 4:
                ...
                self.input_text(create_sale_order_detail_hz['五_2_2_' + flag + '_1_输入框'], first_pay[0][1])
            elif first_pay[0][0] == 3:
                self.is_click(create_sale_order_detail_hz['五_2_2_' + flag + '_1_输入框'])
                self.input_text_with_enter(create_sale_order_detail_hz['五_2_2_' + flag + '_1_输入框'], first_pay[0][1])
            else:
                raise ValueError('传值错误')
            self.input_text(create_sale_order_detail_hz['五_2_2_' + flag + '_2_输入框'], first_pay[1])
            self.is_click(create_sale_order_detail_hz['五_2_2_' + flag + '_4_选择框'])
        ...
        if not five_info['二_3']:
            ...
            if five_info['二_3'][0] == 1:
                self.is_click(create_sale_order_detail_hz['五_2_3_1_1_1_单选按钮'])
            elif five_info['二_3'][0] == 2:
                self.is_click(create_sale_order_detail_hz['五_2_3_1_1_2_单选按钮'])
            elif five_info['二_3'][0] == 3:
                self.is_click(create_sale_order_detail_hz['五_2_3_1_1_3_单选按钮'])
            else:
                raise ValueError('传值错误')
            self.input_text(create_sale_order_detail_hz['五_2_3_1_2_输入框'], five_info['二_3'][1])
            self.is_click(create_sale_order_detail_hz['五_2_3_1_4_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['五_2_3_1_4_输入框'], five_info['二_3'][2])
            if five_info['二_3'][3] == 1:
                self.is_click(create_sale_order_detail_hz['五_2_3_1_5_1_单选按钮'])
            elif five_info['二_3'][3] == 2:
                self.is_click(create_sale_order_detail_hz['五_2_3_1_5_2_单选按钮'])
            else:
                raise ValueError('传值错误')
            if five_info['二_3'][4][0] == 1:
                self.is_click(create_sale_order_detail_hz['五_2_3_2_1_单选按钮'])
                self.is_click(create_sale_order_detail_hz['五_2_3_2_1_选择框'])
                if five_info['二_3'][4][1][0] == 1:
                    self.__choose_value_in_special_drop_down_box(1)
                    self.is_click(create_sale_order_detail_hz['五_2_3_2_1_输入框'])
                    self.input_text_with_enter(create_sale_order_detail_hz['五_2_3_2_1_输入框'], five_info['二_3'][4][1][1])
                elif five_info['二_3'][4][1][0] == 2:
                    self.__choose_value_in_special_drop_down_box(2)
                    self.input_text(create_sale_order_detail_hz['五_2_3_2_1_输入框'], five_info['二_3'][4][1][1])
                else:
                    raise ValueError('传值错误')
            elif five_info['二_3'][4][0] == 2:
                self.is_click(create_sale_order_detail_hz['五_2_3_2_2_单选按钮'])
                self.input_text(create_sale_order_detail_hz['五_2_3_2_2_输入框'], five_info['二_3'][4][1])
            elif five_info['二_3'][4][0] == 3:
                self.is_click(create_sale_order_detail_hz['五_2_3_2_3_单选按钮'])
            else:
                raise ValueError('传值错误')

        self.input_text(create_sale_order_detail_hz['五_2_4_1_输入框'], five_info['二_4'][0])
        self.is_click(create_sale_order_detail_hz['五_2_4_3_选择框'])
        ...
        if five_info['二_4'][1][0] == 1:
            ...
            self.input_text(create_sale_order_detail_hz['五_2_4_3_输入框'], five_info['二_4'][1][1])
        elif five_info['二_4'][1][0] == 3:
            self.is_click(create_sale_order_detail_hz['五_2_4_3_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['五_2_4_3_输入框'], five_info['二_4'][1][1])
        else:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['五_2_4_4_选择框'])
        ...
        # else:
        #     raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['五_2_5_1_选择框'])
        ...
        if five_info['二_5'][0][0] == 1:
            ...
            self.input_text(create_sale_order_detail_hz['五_2_5_1_输入框'], five_info['二_5'][0][1])
        elif five_info['二_5'][0][0] == 3:
            self.is_click(create_sale_order_detail_hz['五_2_5_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['五_2_5_1_输入框'], five_info['二_5'][0][1])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_hz['五_2_5_2_输入框'], five_info['二_5'][1])
        self.is_click(create_sale_order_detail_hz['五_2_5_4_选择框'])
        ...
        if five_info['二_5'][2][0] == 1:
            ...
            self.input_text(create_sale_order_detail_hz['五_2_5_4_输入框'], five_info['二_5'][2][1])
        elif five_info['二_5'][2][0] == 3:
            self.is_click(create_sale_order_detail_hz['五_2_5_4_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['五_2_5_4_输入框'], five_info['二_5'][2][1])
        else:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['五_2_5_5_选择框'])
    ...
    def input_six_info(self, six_info):
        self.is_click(create_sale_order_detail_hz['六_1_选择框'])
        self.__choose_value_in_special_drop_down_box(six_info['网签手续日期'][0])
        if six_info['网签手续日期'][0] == 1:
            self.is_click(create_sale_order_detail_hz['六_1_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['六_1_输入框'], six_info['网签手续日期'][1])
        elif six_info['网签手续日期'][0] == 2:
            self.input_text(create_sale_order_detail_hz['六_1_输入框'], six_info['网签手续日期'][1])
        else:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['六_2_选择框'])
        self.__choose_value_in_special_drop_down_box(six_info['转移登记日期'][0])
        if six_info['转移登记日期'][0] in [1, 2, 4, 5]:
            self.input_text(create_sale_order_detail_hz['六_2_输入框'], six_info['转移登记日期'][1])
        elif six_info['转移登记日期'][0] == 3:
            self.is_click(create_sale_order_detail_hz['六_2_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['六_2_输入框'], six_info['转移登记日期'][1])
        else:
            raise ValueError('传值错误')
        self.is_click(create_sale_order_detail_hz['六_3_选择框'])
        self.__choose_value_in_special_drop_down_box(six_info['登记手续日期'][0])
        if six_info['登记手续日期'][0] in [2, 4]:
            self.input_text(create_sale_order_detail_hz['六_3_输入框'], six_info['登记手续日期'][1])
        elif six_info['登记手续日期'][0] == 3:
            self.is_click(create_sale_order_detail_hz['六_2_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['六_3_输入框'], six_info['登记手续日期'][1])
    ...
    def input_seven_info(self, seven_info):
        self.is_click(create_sale_order_detail_hz['七_1_1_选择框'])
        self.__choose_value_in_special_drop_down_box(seven_info['一'][0])
        if seven_info['一'][0] == 1:
            self.is_click(create_sale_order_detail_hz['七_1_2_输入框'])
            self.input_text_with_enter(create_sale_order_detail_hz['七_1_2_输入框'], seven_info['一'][1])
        elif seven_info['一'][0] in [2, 3, 4, 5]:
            self.input_text(create_sale_order_detail_hz['七_1_2_输入框'], seven_info['一'][1])
        else:
            raise ValueError('传值错误')
        if seven_info['三'] == 1:
            self.is_click(create_sale_order_detail_hz['七_3_2_1_单选按钮'])
        elif seven_info['三'] == 2:
            self.is_click(create_sale_order_detail_hz['七_3_2_2_单选按钮'])
        elif seven_info['三'] == 3:
            self.is_click(create_sale_order_detail_hz['七_3_2_3_单选按钮'])
        else:
            raise ValueError('传值错误')

    def input_eight_info(self, eight_info):
        if 1 in eight_info['一_1']:
            self.is_click(create_sale_order_detail_hz['八_1_1_1_勾选框'])
        if 2 in eight_info['一_1']:
            self.is_click(create_sale_order_detail_hz['八_1_1_2_勾选框'])
        if 3 in eight_info['一_1']:
            self.is_click(create_sale_order_detail_hz['八_1_1_3_勾选框'])
        if 4 in eight_info['一_1']:
            self.is_click(create_sale_order_detail_hz['八_1_1_4_勾选框'])
        if 5 in eight_info['一_1']:
            self.is_click(create_sale_order_detail_hz['八_1_1_5_勾选框'])
        if eight_info['一_2'] == 1:
            self.is_click(create_sale_order_detail_hz['八_1_2_1_单选按钮'])
        elif eight_info['一_2'] == 2:
            self.is_click(create_sale_order_detail_hz['八_1_2_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['一_3'] == 1:
            self.is_click(create_sale_order_detail_hz['八_1_3_1_单选按钮'])
        elif eight_info['一_3'] == 2:
            self.is_click(create_sale_order_detail_hz['八_1_3_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['一_4'] == 1:
            self.is_click(create_sale_order_detail_hz['八_1_4_1_单选按钮'])
        elif eight_info['一_4'] == 2:
            self.is_click(create_sale_order_detail_hz['八_1_4_2_单选按钮'])
        else:
            raise ValueError('传值错误')
        if eight_info['二_税费'][0] == 1:
            self.is_click(create_sale_order_detail_hz['八_2_1_1_单选按钮'])
        elif eight_info['二_税费'][0] == 2:
            self.is_click(create_sale_order_detail_hz['八_2_1_2_单选按钮'])
        elif eight_info['二_税费'][0] == 3:
            self.is_click(create_sale_order_detail_hz['八_2_1_3_单选按钮'])
        elif eight_info['二_税费'][0] == 4:
            self.is_click(create_sale_order_detail_hz['八_2_1_4_单选按钮'])
            self.input_text(create_sale_order_detail_hz['八_2_1_4_输入框'], eight_info['二_税费'][1])
        else:
            raise ValueError('传值错误')
    ...
    def input_twelve_info(self, twelve_info):
        self.input_text(create_sale_order_detail_hz['十二_1_输入框'], twelve_info['一'])
        self.is_click(create_sale_order_detail_hz['十二_2_选择框'])
        if twelve_info['二'][0] <= 3:
            self.__choose_value_in_special_drop_down_box(twelve_info['二'][0])
            self.input_text(create_sale_order_detail_hz['十二_2_输入框'], twelve_info['二'][1])
        else:
            raise ValueError('传值错误')
        self.input_text(create_sale_order_detail_hz['十二_3_输入框'], twelve_info['三'])

    def input_attachment_one_info(self, attachment_one_info):
        """
        填写附件一
        """
        self.input_text(create_sale_order_detail_hz['附件一_家具_书桌_数量'], attachment_one_info['书桌'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_餐桌_数量'], attachment_one_info['餐桌'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_茶几_数量'], attachment_one_info['茶几'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_床_数量'], attachment_one_info['床'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_沙发_数量'], attachment_one_info['沙发'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_衣柜_数量'], attachment_one_info['衣柜'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_床垫_数量'], attachment_one_info['床垫'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_椅子_数量'], attachment_one_info['椅子'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家具_梳妆台_数量'], attachment_one_info['梳妆台'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_电视机_数量'], attachment_one_info['电视机'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_空调_数量'], attachment_one_info['空调'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_冰箱_数量'], attachment_one_info['冰箱'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_洗衣机_数量'], attachment_one_info['洗衣机'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_油烟机_数量'], attachment_one_info['油烟机'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_灶台_数量'], attachment_one_info['灶台'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_微波炉_数量'], attachment_one_info['微波炉'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_电脑_数量'], attachment_one_info['电脑'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_音响_数量'], attachment_one_info['音响'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_饮水机_数量'], attachment_one_info['饮水机'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_灯具_数量'], attachment_one_info['灯具'][1])
        self.input_text(create_sale_order_detail_hz['附件一_家电_机顶盒_数量'], attachment_one_info['机顶盒'][1])

    def input_commission_confirmation_info(self, commission_confirmation_info):
        """
        填写第一份佣金确认书
        """
        self.input_text(create_sale_order_detail_hz['佣金确认书_车位_输入框'], commission_confirmation_info['车位'])
    ...
    def input_commission_confirmation2_info(self, commission_confirmation2_info):
        ...
        填写第二份佣金确认书
        """
        self.input_text(create_sale_order_detail_hz['佣金确认书二_车位_输入框'], commission_confirmation2_info['车位'])
    ...
    def input_receipt_info(self, receipt_info):
        ...
        填写收据
        """
        self.is_click(create_sale_order_detail_hz['收据_日期_输入框'])
        self.input_text_with_enter(create_sale_order_detail_hz['收据_日期_输入框'], receipt_info['日期'])
        collection_details = receipt_info['收款明细']
        if 0 < len(collection_details) < 4:
            for collection in collection_details:
                self.is_click(create_sale_order_detail_hz['收据_支付日期' + str(collection_details.index(collection) + 1)
                                                          + '_输入框'])
                self.input_text_with_enter(
                    create_sale_order_detail_hz['收据_支付日期' + str(collection_details.index(collection) + 1)
                                                + '_输入框'], collection['日期'])
                self.input_text(create_sale_order_detail_hz['收据_支付金额'
