...
class ReconciliationTablePage(WebPage):
    ...
    def get_table_data(self):
        ...
        for i in range(len(self.find_elements(table_row_locator))):
            ...
            reconciliation_info = {
                'reconciliation_code': self.element_text(reconciliation_code_locator),
            ...
            reconciliation_money_info = {
                ...
                'payable_money': self.element_text(payable_money_locator)
            }
            ...
            status_info = {
                'accounting_model': self.element_text(accounting_model_locator),
            ...
            row_data = {
                ...
                'date_info': self.element_text(create_time_locator)
            }
