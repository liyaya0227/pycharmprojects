...
#         if int(num) > 0:
#             house_detail.enter_house_detail('买卖')
...
#         house_detail = HouseDetailPage(web_driver)
#         house_detail.change_role('经纪人')
#         print('test_report_house:sale_house_code', sale_house_code)
#         print('test_report_house:', rent_house_code)
...
#         num = house_detail.get_house_num(rent_house_code, flag)
#         if int(num) > 0:
#             house_no, initial_price, house_area = house_detail.enter_house_detail(flag)
