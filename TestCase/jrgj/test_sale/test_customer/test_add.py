...
class TestAdd(object):
    ...
    json_file_path = cm.test_data_dir + "/jrgj/test_sale/test_customer/test_add_" + ini.environment + ".json"
    ...
    def test_001(self, web_driver):
        ...
        customer_add.choose_purchase_house_purpose(self.test_data['购房目的'])
        ...
        customer_add.choose_use(self.test_data['用途'])
        customer_add.choose_pay_type(self.test_data['付款方式'])
        customer_add.input_first_pay(self.test_data['首付'])
        customer_add.input_month_pay(self.test_data['月供'])
