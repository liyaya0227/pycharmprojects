...
class TestRentNoEstateDictHouseFeedback(object):
    ...
    def create_no_dict_house(web_driver, house_info: dict):
        ...
        house_add.add_no_estate_dict_house('租赁', house_info['estate_name'], house_info['building_id'],
    ...
    def reject_no_dict_house_feedback_by_estate_name(web_driver, estate_name: str, reason: str):
        ...
        no_dict_house_feedback_table.click_rent_tab()
